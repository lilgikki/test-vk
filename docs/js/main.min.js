...
var BOMBS_COUNT = 40;
var field = document.querySelector('.field');
var playButton = document.querySelector('.minesweeper__play');
var openCells = 0;
var firstClick = true;
...
var generateArrayRandomNumber = function generateArrayRandomNumber(min, max, firstNum) {
  ...
  while (arrayRandomNumbers.length < BOMBS_COUNT) {
    ...
    var emptyFirstClick = arrayTotalNumbers[tempRandomNumber] !== firstNum;
...
var activateCell = function activateCell() {
  ...
  var clearGame = function clearGame() {
    ...
    (0,_bombs_js__WEBPACK_IMPORTED_MODULE_1__.resetBombs)();
    // Закрытие всех ячеек
    for (var _o = 0; _o < FIELD__SIZE * FIELD__SIZE; _o++) {
  ...
  var gameWin = function gameWin() {
    ...
    for (var o = 0; o < FIELD__SIZE * FIELD__SIZE; o++) {
...
/* harmony import */ var _minesweeper_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./minesweeper.js */ "./js/minesweeper.js");


window.addEventListener('DOMContentLoaded', function () {
  (0,_field_js__WEBPACK_IMPORTED_MODULE_0__.renderCells)(_minesweeper_js__WEBPACK_IMPORTED_MODULE_1__.activateCell);
});
})();
